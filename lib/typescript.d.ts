...
declare namespace ts {
    ...
    interface TransformationContext {
         ...
         *
         * NOTE: Transformation hooks should only be modified during `Transformer` initialization, id:54 gh:55
         ...
         *
         * NOTE: Transformation hooks should only be modified during `Transformer` initialization, id:5 gh:6
         * before returning the `NodeTransformer` callback.
         */
