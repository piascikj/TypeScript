...
namespace ts {
     ...
     * }
     *
     * NOTE: values to out parameters are not copies if loop is abrupted with 'return' - in this case this will end the entire enclosing function id:317 gh:318
    ...
    const enum HierarchyFacts {
        ...
        // NOTE: do not add more ancestor flags without also updating AncestorFactsMask below. id:228 gh:229
    ...
    export function transformES2015(context: TransformationContext) {
        ...
        function generateCallToConvertedLoop(loopFunctionExpressionName: Identifier, parameters: ParameterDeclaration[], state: ConvertedLoopState, isAsyncBlockContainingAwait: boolean): Statement[] {
            ...
            // NOTE: if loop uses only 'continue' it still will be emitted as simple loop id:221 gh:222
            const isSimpleLoop =
        ...
        function visitTaggedTemplateExpression(node: TaggedTemplateExpression) {
            ...
            // NOTE: The parentheses here is entirely optional as we are now able to auto- id:267 gh:268
         ...
         * NOTE: This function expects to be called with an original source tree node. id:320 gh:321
         *
